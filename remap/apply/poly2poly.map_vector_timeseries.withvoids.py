...
#                    times, hrus, hru_type):    
def writeNetCDFData(fn, var, times, hrus, hru_type, varname):    
...
#                        times, hrus, hru_type)        
        ...
        times,hrus,var=compAvgVal(wgts, nc_in, varname)

        writeNetCDFData(nc_out, var, times, hrus, hru_type, varname)   
